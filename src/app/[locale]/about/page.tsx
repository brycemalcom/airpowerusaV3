...
export const metadata: Metadata = {
  ...
  description:
    "Learn about AirPower USA's mission to redefine clean, reliable, and deployable power with patented compressed air technology. Discover our story, values, and vision for the future.",
  keywords:
    "AirPower USA about, company mission, clean energy technology, compressed air engine, zero emissions power",
};

export default function AboutPageLocale() {
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 mx-auto max-w-5xl px-6 py-24 text-center lg:px-8">
          <h1
            className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl xl:text-7xl drop-shadow-2xl mb-8"
            style={{ textShadow: '3px 3px 6px rgba(0,0,0,0.8), 0 0 20px rgba(0,0,0,0.5)' }}
          >
            About AirPower USA
          </h1>
          <p
            className="text-xl sm:text-2xl text-white/90 leading-relaxed max-w-4xl mx-auto font-light"
